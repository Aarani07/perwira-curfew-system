...
def send_warning_letter_email(
    ...
    user = "kklkcurfewsystem25@gmail.com"
    password = "ovpjwyingdinwkgw"  # Gmail App Password

    msg = EmailMessage()

    msg["Subject"] = "Official Warning Letter Notification"
    msg["From"] = user
    msg["To"] = to_email
...
This email is to inform you that an official warning letter has been issued regarding a residential curfew violation.

Warning Letter Number: {warning_no}
Violation Date: {violation_date}

Please log in to the PRCDS system to review and acknowledge the warning letter.

Failure to acknowledge the warning letter may result in additional disciplinary action.

Regards,

KKLK Curfew Detection System
        ...
        if request.method == "POST":
            ...
            if step == "email":
                ...
                if not user:
                    ...
                    print("DEBUG EMAIL_PASS exists:", os.getenv("EMAIL_PASSWORD") is not None)
